...
/*class NotSelectedExdeption extends RuntimeException{//creating user defined exception
NotSelectedExdeption(String s){
super(s);
}
}*/
...
public class RecruitmentProcess {
	...
	public static void main(String[] args) {
		...
		if (Process == 1) {
			...
			rp.procedure();
		} else if (Process == 2) {// here inheritence is used we can say that as same object is used to call all
									// the sub classes
